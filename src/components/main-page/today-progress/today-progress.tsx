    ...
    return (
        <div className={styles.today_progress_container}>
            <span>
                ...
                <p className={styles.today_description}>Today you have learned<span className={styles.bold_text}>15 new words</span>, including<span className={styles.bold_text}>5 complex words</span>.</p>
            </span>
