...
function Games() {
  return (
    <div className={styles.container}>
      ...
      <Game path='speakit' text="Improve a reaction when you guess words in hurry mode" Image={Lion} caption="Savannah" isEven />
      <Game path='speakit' text="Allows you to improve listening comprehension of English" Image={Calling} caption="Audio Call" />
      <Game path='speakit' text="You need to quickly decide the correct one is the translation of the word" Image={Sprinter} caption="Sprint" isEven />
      ...
      <Game path='speakit' text="Surprise" Image={Surprise} caption="Special OwnGame" isEven />
    </div>
  );
}
