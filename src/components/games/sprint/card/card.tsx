...
export default ({
  couple, wordsIndex, setWordsIndex, isActive, setTotalPoints, setCorrectWords,
  points, setPoints, checkedCircles, setCheckedCircles,
  allWords, fullCorrectList,
}: CardProps) => {
  ...
  return (
    <>
      <div className={styles.wordsContainer}>
        <div className={styles.wordPoints} style={{ backgroundColor: `${backColor}` }}>
          +
          {points}
        </div>
